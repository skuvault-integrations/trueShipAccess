...
namespace TrueShipAccess
{
	public interface ITrueShipCommonService
	{
		...
		Task< bool > UpdateOrderItemPickLocations( IEnumerable< ItemLocationUpdateModel > orderitemlist, CancellationToken ctx );
		Task< IEnumerable< OrderResource.TrueShipOrder > > GetUnshippedOrdersAsync( DateTime dateTo, CancellationToken ct );
		/// <summary>
